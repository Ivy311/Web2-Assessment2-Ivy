...
@Component({
  selector: 'app-list',
  standalone: true,
  imports: [RouterOutlet, RouterLink, MatFormField, MatLabel, MatOption, MatSelect, NgForOf, FormsModule, MatInput, MatTable, MatColumnDef, MatHeaderCell, MatCell, MatHeaderCellDef, MatCellDef, MatHeaderRow, MatRow, MatRowDef, MatHeaderRowDef, NgIf],
...
export class ListComponent implements OnInit{
  ...
  deleteHandler(data: any) {
    ...
    if (flag) {
      this.http.delete(baseUrl + 'api/admin/deleteFundraiser/' + data.FUNDRAISER_ID).subscribe(res => {
